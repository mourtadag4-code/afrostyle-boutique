...
$sql_stats = "SELECT DATE_FORMAT(date_commande, '%b') as mois, SUM(montant_total) as total 
              FROM commande GROUP BY MONTH(date_commande) 
              ORDER BY date_commande ASC LIMIT 6";
...
<div class="main-content">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-4">
            <div class="card p-4 border-0 shadow-sm rounded-4">
                <h6 class="text-muted small uppercase fw-bold">Promotions</h6>
                <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-4">
            <div class="card p-4 border-0 shadow-sm rounded-4">
                <h6 class="text-muted small uppercase fw-bold">Clients</h6>
                <div class="d-flex justify-content-between align-items-center">
