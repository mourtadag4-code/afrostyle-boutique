-- =============================================
-- INSERTION DES DONNÉES AFROSTYLE SHOP
-- =============================================
...
(29, 19, 5, 1, 40000.00),
(30, 19, 4, 1, 30000.00),
(31, 20, 16, 1, 100000.00),
(32, 20, 5, 1, 40000.00),
(33, 20, 4, 4, 30000.00),
(34, 21, 16, 1, 100000.00),
(35, 21, 36, 1, 3000000.00),
(36, 21, 17, 1, 50000.00),
(37, 21, 13, 1, 500000.00),
(38, 21, 5, 1, 40000.00),
(39, 21, 12, 1, 25000.00),
(40, 22, 36, 5, 3000000.00),
(41, 22, 17, 1, 50000.00),
(42, 22, 13, 1, 500000.00),
(43, 22, 14, 1, 5000.00),
(44, 23, 36, 4, 3000000.00),
(45, 23, 17, 2, 50000.00),
(46, 24, 36, 4, 3000000.00),
(47, 24, 17, 3, 50000.00),
(48, 24, 14, 3, 5000.00),
(49, 25, 36, 4, 3000000.00),
(50, 25, 17, 3, 50000.00),
(51, 25, 14, 3, 5000.00),
(52, 26, 15, 3, 15000.00),
(53, 26, 36, 4, 1000000.00),
(54, 26, 17, 1, 50000.00),
(55, 27, 17, 3, 50000.00),
...
(61, 28, 15, 1, 15000.00),
(62, 28, 12, 1, 25000.00),
(63, 28, 36, 1, 3000000.00),
(64, 29, 36, 3, 3000000.00),
(65, 29, 16, 3, 80000.00),
(66, 30, 14, 3, 5000.00),
(67, 30, 16, 1, 80000.00),
(68, 31, 17, 1, 50000.00),
(69, 32, 16, 4, 80000.00),
(70, 33, 36, 1, 3000000.00),
(71, 33, 16, 3, 80000.00),
(72, 34, 36, 1, 3000000.00),
(73, 34, 16, 1, 80000.00),
...
(89, 45, 17, 1, 50000.00),
(90, 46, 17, 1, 50000.00),
(91, 47, 36, 4, 3000000.00),
(92, 47, 17, 1, 50000.00),
(93, 48, 36, 2, 1500000.00),
(94, 48, 17, 1, 25000.00),
(95, 48, 16, 2, 80000.00),
(96, 48, 14, 3, 5000.00),
(97, 49, 36, 1, 1500000.00),
(98, 50, 36, 2, 1500000.00),
(99, 51, 17, 1, 50000.00),
(100, 51, 14, 3, 5000.00),
(101, 51, 15, 3, 15000.00),
(102, 51, 16, 1, 100000.00),
(103, 51, 5, 3, 40000.00),
(104, 52, 36, 1, 1500000.00),
...
(1, 1, 17, 1, '2026-01-16 14:56:23'),
(2, 3, 12, 1, '2026-01-16 16:15:30'),
(3, 3, 14, 1, '2026-01-16 16:15:37'),
(4, 3, 1, 1, '2026-01-16 16:15:54'),
(5, 1, 14, 3, '2026-01-16 16:31:26'),
(6, 1, 15, 3, '2026-01-19 10:12:54'),
(7, 1, 16, 1, '2026-01-19 10:57:33'),
(8, 1, 5, 3, '2026-01-19 11:18:47');

-- 11. PROMOTIONS
INSERT INTO `promotion` (`id_promotion`, `id_produit`, `code_promo`, `pourcentage_reduction`, `date_debut`, `date_fin`) VALUES
(1, 3, 'SN17', 10.00, '2026-01-25', '2026-01-30'),
(2, 13, 'Djanis17', 20.00, '2026-01-25', '2026-01-30'),
(3, 38, 'nim17', 10.00, '2026-01-22', '2026-01-23'),
(4, 13, 'sounis17', 10.00, '2026-01-20', '2026-01-21'),
(5, 5, 'MN17', 20.00, '2026-01-25', '2026-02-27'),
(6, 31, 'nis123', 20.00, '2026-01-22', '2026-01-27'),
(7, 33, 'nis1017', 10.00, '2026-01-22', '2026-02-19');

-- Réactiver les vérifications des clés étrangères
SET FOREIGN_KEY_CHECKS = 1;

-- Confirmation
SELECT 'Toutes les données ont été insérées avec succès !' AS Message;